...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'salaobyme.Usuario'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'salaobyme.UsuarioPermissao'
grails.plugins.springsecurity.authority.className = 'salaobyme.Permissao'
...
grails.plugins.springsecurity.successHandler.defaultTargetUrl = '/principal.zul'
